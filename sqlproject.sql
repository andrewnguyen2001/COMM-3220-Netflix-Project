CREATE DATABASE IF NOT EXISTS an2dgq_Hotels;
USE an2dgq_Hotels;
...
INSERT INTO Devices VALUES
 (110101, 'iPhone 13', '92.205.200.224', 200001),
(101010, 'iPad Air', '110.190.21.169', 200001),
(111111, 'Samsung Galaxy', '86.154.30.182', 200002), 
(100000, 'Roku', '11.224.220.131', 200002), 
(111011, 'Playstation 4', '54.1.158.70', 200003),
(100100, 'Playstation 5', '28.222.248.70', 200003), 
(110001, 'XBox 360', '168.197.77.142', 200004), 
(101110, 'XBox 1', '89.140.102.75', 200004), 
(110111, 'iPhone XS', '246.154.106.102', 200005),
(101000, 'iPhone 10', '247.117.123.6', 200005);
...
CREATE TABLE Content (
 ...
 (61234, 'Bridgerton', 'Chris Van Dusen', 'Adjoa Andoh, Julie Andrews, Lorraine Ashbourne', 2022, 7), 
 (61235, 'Titanic', 'James Cameron', 'Kate Winslet, Leonardo Dicaprio, Billy Zane', 1997, 7),
 (61236, 'Django Unchained', 'Quentin Tarantino', 'Leonardo Dicaprio, Jamie Foxx, Samuel L. Jackson', 2012, 8),
 (61237, 'Love Is Blind', 'Matt Thomas', 'Nick Lachey, Vanessa Lachey', 2022, 7),
 (61238, 'Parasite', 'Bong Joon-Ho', 'Song Kang-Ho, Lee Sun-Kyun, Cho Yeo-Jeong', 2019, 2),
 (61239, 'Scream', 'Wes Craven', 'David Arquette, Neve Campbell, Courtney Cox', 1996, 6),
 (81234, 'A Nightmare on Elm Street', 'Wes Craven', 'Robert Englund, Johnny Depp, Heather Langenkamp', 1984, 6),
(81235, 'Queer Eye', 'David Collins', 'Bobby Berk, Karamo Brown, Tan France', 2021, 1),
(81236, 'Demon Slayer', 'Haruo Sotozaki', 'Natsuki Hanae, Akari Kito, Hiro Shimono', 2019, 5),
(81237, 'Hercules', 'Ron Clements, John Musker', 'Tate Donovan, Danny DeVito, James Woods', 1997, 5);
